...
class CompleteReport(SimpleReport):
    ...
    def generate(cls, produtos):
        ...
        dados = Counter(produto["nome_da_empresa"] for produto in produtos)
        produtos_estocados = "Produtos Estocados por empresa: \n"
        for chave, valor in dados.items():
            produtos_estocados += f"- {chave}: {valor}\n"
...
print(CompleteReport.generate(teste_local)) """
